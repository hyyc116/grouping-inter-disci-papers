...
def top_paper_info():
    ...
    sql = "select A.paper_id,A.year,A.paper_title,A.original_venue,C.display_name from mag_core.papers as A, mag_core.paper_author_affliations as B, mag_core.authors as C where A.paper_id = B.paper_id and B.author_id = C.author_id and A.paper_id="
